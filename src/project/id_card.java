...
ResultSet rs ;
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(202, 219, 231));
        jPanel1.setMinimumSize(new java.awt.Dimension(908, 485));

        jPanel3.setBackground(new java.awt.Color(54, 102, 142));
        jPanel3.setPreferredSize(new java.awt.Dimension(908, 80));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 204, 204));
        jLabel1.setText("Id_Card");
        ...
        jLabel8.setText("Material_Status");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(stat, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                        .addGap(242, 242, 242))
                    .addGroup(jPanel1Layout.createSequentialGroup()
  ...
  try {         
                ...
                Class.forName(driver);
                 Connection con = DriverManager.getConnection(url,user,password);
                  String sql = "insert into id_card  values ( "+id+",'"+name.getText()+"' ,'"+add.getText()+"','"+gend.getText()+"', '"+stat.getText()+"','"+job.getText()+"','"+city.getText()+"') "; 
